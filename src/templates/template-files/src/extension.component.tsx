  ...
  return (
    <div className={styles.container}>
      <h3 className={styles.title}>
        {t('{{camelCase currentExtension.componentName}}Title', '{{currentExtension.componentName}}')}
      </h3>
      <p className={styles.description}>
        {t('{{camelCase currentExtension.componentName}}Description', 'This is the {{currentExtension.componentName}} extension.')}
      </p>
